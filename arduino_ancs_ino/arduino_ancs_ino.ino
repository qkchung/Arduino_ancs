...
/* ================ Status Handling ================ */      
      ...
      // incoming call will be alerted as new message
      // this is to remove call alert signal
      if (strstr(buf,"Incoming Call Stop")){
       
      Serial.write("Incoming Call Stop\n");
      }
      // this is to remove call alert signal
      if (strstr(buf,"Missed Call Checked")){
       
      Serial.write("Miss Call Checked\n");
      }
